/* =========================================================
   ...
   Clean rules:
   - Product cards show: image, collection, name, price, shortDescription, buttons.
   - Product popup shows: gallery, name, price, longDescription/description, material, dimensions, leadTime, WhatsApp.
   - Removed clutter: availability, collection repeated in details, additional information dump.
   - Still reads products ONLY from Google Sheets.
   ========================================================= */
  ...
  modal.innerHTML = `
    <div class="modal-inner">
      ...
      <div class="modal-copy">
        ...
        ${cleanProductDetailsHTML(product)}
...
function cleanProductDetailsHTML(product) {
  const details = [
  ...
  return `
    <div class="product-detail-list clean-details">
